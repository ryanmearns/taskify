import { Button, ButtonIcon, FadeIn, FadeInStagger, Flex } from "@playbook/ui";
import {
  ArrowLeft,
  ArrowRight,
  ListChecks,
        ...
        <FadeInStagger>
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              <FadeIn>
                <h1 className="text-5xl font-bold pb-2 bg-clip-text text-transparent bg-gradient-to-l from-primary to-primary/60 sm:text-6xl">
                  {props.title}
                </h1>
              </FadeIn>
              <FadeIn>
