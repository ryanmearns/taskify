...
const TodoList = (props: { todos: Todos; projects: Projects }) => {
  ...
  const [order, setOrder] = useLocalStorage<"status" | "due-date">(
    "storage-key",
    "status"
  );
...
const TodoItem = (props: {
  ...
  return (
    <div className="text-sm group hover:bg-secondary cursor-pointer flex px-4 items-center gap-2">
